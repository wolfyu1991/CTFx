...
class HTMLOperation {
    ...
    toStubHtml(removeIcon = false, elementId = null) {
        ...
        if (this.description) {
            ...
            html += ` data-bs-container='body' data-toggle='popover' data-bs-placement='right'
                data-bs-content="${content}" data-bs-html='true' data-bs-trigger='hover'
                data-bs-boundary='viewport' role='button'`;
        }
