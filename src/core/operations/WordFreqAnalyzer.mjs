...
/**
 * WordFreqAnalyzer operation
 */
class WordFreqAnalyzer extends Operation {

    /**
     * WordFreqAnalyzer constructor
     */
    constructor() {
        super();
...
export default WordFreqAnalyzer;
